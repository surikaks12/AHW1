...
public class Department {
    ...
    @OneToMany(mappedBy = "dep", fetch = FetchType.LAZY , cascade = CascadeType.ALL, orphanRemoval = false)
    private List<Department_Employee> product_colors= new ArrayList<Department_Employee>();
    ...
    public boolean equals(Object o) {
        ...
        Department product = (Department) o;
